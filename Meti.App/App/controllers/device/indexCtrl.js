app.controller('device-indexCtrl',
    ['$scope',
        ...
        function ($scope, $log, toastr, responseDispatcherService, deviceService, $q, $uibModal, NgTableParams, ngTableService, utilsService, $rootScope, processInstanceService) {
            //#region Model
            $scope.model = {
                macaddress: null,
                name: null,
            ...
            $scope.$watchGroup(['model.macaddress', 'model.name', 'model.isEnabled', 'model.processInstanceId'],
            ...
            $scope.clearFilter = function () {
                ...
                $scope.model.processInstanceId = null;
            ...
            $scope.fetch = function (startRowIndex, maxRowIndex, orderByProperty, orderByType) {
                ...
                var request =
                {
                    ...
                    'isEnabled': '',
                    'processInstanceId': $scope.model.processInstanceId ? $scope.model.processInstanceId.id : '',
            ...
            var fetchEssentialData = function () {
                ...
                deviceService.fetchEssentialData(request)
                    .then(function (response) {
                        ...
                        $scope.model.processInstanceList = Enumerable.from(data.processInstanceList).select(function (x) { return processInstanceService.processInstanceIndexModel(x) }).toArray();
