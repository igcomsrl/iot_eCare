        ...
        function (apiEndPoint, zeusEndpoint) {
            ...
            factory.routeMap =
            {
                ...
                processInstance: {
                    ...
                    updatePositionLast: apiEndPoint + "api/processInstance/updatePositionLast",
                    close: apiEndPoint + "api/processInstance/close",
                    open: apiEndPoint + "api/processInstance/open"
                },
                registry: {
                    ...
                    deleteFile: apiEndPoint + "api/registry/deleteFile",
                    createFile: apiEndPoint + "api/registry/createFile",
                    fetchByProcessInstanceIds: apiEndPoint + "api/registry/fetchByProcessInstanceIds"
                },
                parameter: {
                ...
                healthRisk: {
                    fetch: apiEndPoint + "api/healthRisk/fetch",
                    fetchEssentialData: apiEndPoint + "api/healthRisk/fetchEssentialData",
                    deleteItem: apiEndPoint + "api/healthRisk/delete",
                    fetchByProcessInstanceIds: apiEndPoint + "api/healthRisk/fetchByProcessInstanceIds"
                }
            };
