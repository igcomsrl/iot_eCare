app.factory('registryService',
    ['utilsService',
        ...
        'fileService',
        'healthRiskService',
        function (utilsService, serverRouteMap, httpService, utilsService, fileService, healthRiskService) {
            var factory = {};
            ...
            factory.registryIndexModel = function(dto) {
                ...
                var model = {
                    ...
                    'latitudeLast': dto.latitudeLast,
                    'longitudeLast': dto.longitudeLast
                }
            ...
            factory.registryDetailModel = function (dto) {
                ...
                var model = {
                    ...
                    'weight': dto.weight,
                    'height': dto.height,
                    'files': dto.files ? Enumerable.from(dto.files).select(function (x) { return fileService.fileModel(x) }).toArray() : [],
                    'healthRisks': dto.healthRisks ? Enumerable.from(dto.healthRisks).select(function (x) { return healthRiskService.healthRiskEditModel(x) }).toArray() : [],
                    'lifeStyle': dto.lifeStyle ? utilsService.createItemDtoModel(dto.lifeStyle) : null
                };
            ...
            factory.registryEditModel = function (dto) {
                ...
                if (model.latitudeLast && model.longitudeLast)
                    model.latlngLast = [parseFloat(model.latitudeLast.replace(",", ".")), parseFloat(model.longitudeLast.replace(",", "."))];
            ...
            factory.deleteFile = function (request) {
                return httpService.httpRequest(serverRouteMap.routeMap.registry.deleteFile, "POST", request);
            }
            ...
            factory.fetchByProcessInstanceIds = function (request) {
                return httpService.httpRequest(serverRouteMap.routeMap.registry.fetchByProcessInstanceIds, "POST", request);
            }
