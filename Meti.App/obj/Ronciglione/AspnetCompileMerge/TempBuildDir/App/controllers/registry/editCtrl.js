app.controller('registry-editCtrl',
    ['$scope',
        ...
        'serverRouteMap',
        'healthRiskService',
        function ($scope, $log, responseDispatcherService, registryService, $uibModalInstance, $q, registryId, toastr, utilsService, $rootScope, processInstanceService, Upload, fileService, serverRouteMap, healthRiskService) {
            //#region Model
            $scope.title = '';
            ...
            var fetchEssentialData = function () {
                ...
                registryService.fetchEssentialData(request)
                    .then(function (response) {
                        ...
                        $scope.lifeStyleList = Enumerable.from(data.lifeStyleList).select(function (x) { return utilsService.createItemDtoModel(x) }).toArray();
            ...
            var get = function (id) {
                ...
                promise.then(function (dto) {
                    ...
                    healthRiskService.registryId = $scope.registryModel.id;
                    $rootScope.$broadcast("registryModelUpdated");
            ...
            $scope.save = function () {
                ...
                var request = {
                    ...
                    'healthRisks': healthRiskService.healthRisks,
                    'lifeStyle': $scope.registryModel.lifeStyle ? $scope.registryModel.lifeStyle.id : '',
                }
