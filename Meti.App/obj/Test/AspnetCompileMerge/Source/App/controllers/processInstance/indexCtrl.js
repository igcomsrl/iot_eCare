app.controller('processInstance-indexCtrl',
    ['$scope',
        ...
        'geolocationService',
        'utilsService',
        function ($scope, $log, toastr, responseDispatcherService, processInstanceService, $q, NgTableParams, ngTableService, $state, registryService, processService, $uibModal, geolocationService, utilsService) {
            //#region Model
            $scope.model = {
                name: null,
                doctor: null,
            ...
            $scope.$watchGroup(['model.doctor', 'model.patient', 'model.process', 'model.processInstanceState'],
            ...
            $scope.clearFilter = function () {
                ...
                $scope.model.processInstanceState = null;
            ...
            $scope.fetch = function (startRowIndex, maxRowIndex, orderByProperty, orderByType) {
                ...
                var request =
                {
                    ...
                    'processInstanceState': $scope.model.processInstanceState ? $scope.model.processInstanceState.id : '',
            ...
            var fetchEssentialData = function () {
                ...
                processInstanceService.fetchEssentialData(request)
                    .then(function (response) {
                        ...
                        $scope.model.processInstanceStateList = Enumerable.from(data.processInstanceStateList).select(function (x) { return utilsService.createItemDtoModel(x) }).toArray();
