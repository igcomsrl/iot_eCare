app.controller('sidebarCtrl',
    ...
    'accountService',
        function ($scope, $log, alarmFiredService, $rootScope, $interval, accountService) {
            ...
            $scope.isMedico = accountService.isMedico();
            $scope.isCentraleOperativa = accountService.isCentraleOperativa();
            $scope.isConfiguratore = accountService.isConfiguratore();
            ...
            $rootScope.$on("sidebar-fetchAlarmFired", function (data) {
                fetch();
            });
