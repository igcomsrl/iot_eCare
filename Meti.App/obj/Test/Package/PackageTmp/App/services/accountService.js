app.factory("accountService",
    ["httpService", "serverRouteMap", "$q", "$rootScope", "zeusAuthService",
        function (httpService, coreRouteMap, $q, $rootScope, zeusAuthService) {
            ...
            factory.isMedico = function () {
                return zeusAuthService.hasClaim([{ "claimType": "", "claimValues": ["IsMedico"] }]);
            }

            factory.isCentraleOperativa = function () {
                return zeusAuthService.hasClaim([{ "claimType": "", "claimValues": ["IsCentraleOperativa"] }]);
            }

            factory.isConfiguratore = function () {
                return zeusAuthService.hasClaim([{ "claimType": "", "claimValues": ["IsConfiguratore"] }]);
            }
